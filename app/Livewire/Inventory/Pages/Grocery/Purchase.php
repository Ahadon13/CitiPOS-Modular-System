...
#[Layout('components.layouts.grocery', ['title' => 'Inventory Purchase', 'inventory' => true])]
final class Purchase extends Component
{
    ...
    public function baseQuery(): Builder|PurchaseModel
    {
        ...
        $query->whereHas('purchaseItems.product.productCategory', fn (Builder $q) => $q->where('name', CategoryType::Grocery->value));
    ...
    public function stats(): array
    {
        ...
        $query = PurchaseModel::where('branch_id', $this->currentBranchId)
            ->whereHas('purchaseItems.product.productCategory', fn (Builder $q) => $q->where('name', CategoryType::Grocery->value));
