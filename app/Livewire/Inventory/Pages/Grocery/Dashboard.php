...
#[Layout('components.layouts.grocery', ['title' => 'Grocery Dashboard', 'inventory' => true])]
final class Dashboard extends Component
{
    ...
    {
        $fileName = 'grocery-stock-movements-' . now()->format('Y-m-d_H-i-s') . '.xlsx';
    ...
    /**
     * Helper to apply the grocery product category filter.
     */
