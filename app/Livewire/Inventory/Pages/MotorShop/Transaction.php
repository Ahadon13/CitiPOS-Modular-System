...
class Transaction extends Component
{
    ...
    public function baseQuery(): Builder|Sale
    {
        ...
        $query->whereHas('saleItems.product.productCategory', fn (Builder $q) => $q->where('name', CategoryType::MotorShop->value));
    ...
    public function topDemandProducts()
    {
        ...
        return \App\Models\SaleItem::selectRaw('product_id, SUM(quantity) as total_sold, SUM(subtotal) as total_revenue')
            ...
            ->whereHas('product.productCategory', fn (Builder $query) => $query->where('name', CategoryType::MotorShop->value))
    ...
    public function downloadDailyReport()
    {
        ...
        try {
            ...
            $fileName = 'Motor Shop_Daily_Report_' . $parsedDate->format('Y_m_d') . '.xlsx';
