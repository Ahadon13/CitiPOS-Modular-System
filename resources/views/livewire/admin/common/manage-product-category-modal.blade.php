<div>
    <x-ui.modal id="manage-product-category" width="3xl" heading="Manage Product Categories">
        ...
        <div class="pt-4 flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3 border-t border-black/10 dark:border-white/10 mt-6">
            <x-ui.button variant="outline" color="neutral" type="button" class="w-full sm:w-auto justify-center" x-on:click="$dispatch('close-modal', { id: 'manage-product-category' })">
                Close
            </x-ui.button>
        </div>
    </x-ui.modal>
