<div class="max-w-7xl mx-auto space-y-6">
    <x-ui.breadcrumbs>
        <x-ui.breadcrumbs.item href="{{ route('inventory.motor-shop.products') }}">
            Products
    ...
    <div class="flex items-center gap-5 justify-between">
        ...
        <x-ui.button variant="outline" icon="arrow-left" color="neutral" href="{{ route('inventory.motor-shop.products') }}">
            Back to list
        </x-ui.button>
    </div>
    ...
    <x-ui.card hoverless size="full">
        ...
        <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
            Create one row per product. To add larger packagings (e.g., boxes or cartons) to a base product (e.g., pieces), create a new row with the <strong>same Product Code</strong>. Columns highlighted in <span class="text-green-600 dark:text-green-400 font-medium">green</span> are required for the base product.
        </p>
            ...
            <table class="min-w-full divide-y divide-neutral-200 dark:divide-white/10 text-sm text-left">
                <thead class="bg-neutral-50 dark:bg-white/5 text-neutral-600 dark:text-neutral-300">
                    <tr>
                        ...
                        <th class="px-4 py-3 font-medium">oem_number</th>
                        <th class="px-4 py-3 font-medium">vehicle_model</th>
                        <th class="px-4 py-3 font-medium">engine_type</th>
                        <th class="px-4 py-3 font-medium">year_range</th>
                ...
                <tbody class="divide-y divide-neutral-200 dark:divide-white/10 bg-white dark:bg-transparent text-neutral-800 dark:text-neutral-200">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3">Bosch Oil Filter</td>
                        <td class="px-4 py-3">Filters</td>
                        <td class="px-4 py-3">Sample Supplier</td>
                        <td class="px-4 py-3">piece</td>
                        ...
                        <td class="px-4 py-3 text-neutral-400">15400-PLM-A02</td>
                        <td class="px-4 py-3 text-neutral-400">Toyota Vios</td>
                        <td class="px-4 py-3 text-neutral-400">1.3L / 2NZ-FE</td>
                        <td class="px-4 py-3 text-neutral-400">2014-2018</td>
                        <td class="px-4 py-3 text-neutral-400">Compatible with selected 1.5L engines</td>
                    </tr>
                    {{-- Packaging Row --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @php
                        $required = ['product_code', 'brand_name', 'category', 'supplier', 'unit', 'conversion', 'cost_price', 'selling_price', 'quantity_on_hand', 'reorder_level'];
                        @endphp
