<div class="max-w-7xl mx-auto space-y-6" x-data="{ packagings: @entangle('form.packagings') }">
    ...
    <div class="flex items-center gap-5 justify-between">
        <div>
            ...
            <p class="text-neutral-500 dark:text-neutral-400">Add a new motor part with stock, barcode, and packaging prices.</p>
        </div>
            ...
            <x-ui.card hoverless size="full">
                ...
                <x-ui.field class="mt-5">
                    ...
                    <x-ui.textarea
                        ...
                        placeholder="e.g. Compatible with 1.5L engines"
                    />
