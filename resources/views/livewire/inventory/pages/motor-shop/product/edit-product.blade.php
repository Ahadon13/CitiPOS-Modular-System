<div class="max-w-7xl mx-auto space-y-6"
    ...
    <form wire:submit.prevent="save" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <x-ui.card hoverless size="full">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <x-ui.field required>
                        ...
                        <x-ui.input wire:model="form.brand_name" placeholder="e.g. Bosch Oil Filter" />
                ...
                <x-ui.field required class="mt-5">
                    ...
                    <x-ui-select.styled
                        ...
                        searchable
                        placeholder="Select or create a category (e.g. Filters)"
                    >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5 pt-5 border-t border-black/5 dark:border-white/5">
                    <x-ui.field>
                        <x-ui.label>Part Number</x-ui.label>
                        <x-ui.input wire:model="form.part_number" placeholder="e.g. OF-1234" />
                        <x-ui.error name="form.part_number" />
                    </x-ui.field>

                    <x-ui.field>
                        <x-ui.label>OEM Number</x-ui.label>
                        <x-ui.input wire:model="form.oem_number" placeholder="e.g. 15400-PLM-A02" />
                        <x-ui.error name="form.oem_number" />
                    </x-ui.field>

                    <x-ui.field>
                        <x-ui.label>Vehicle Model</x-ui.label>
                        <x-ui.input wire:model="form.vehicle_model" placeholder="e.g. Toyota Vios" />
                        <x-ui.error name="form.vehicle_model" />
                    </x-ui.field>

                    <x-ui.field>
                        <x-ui.label>Engine Type</x-ui.label>
                        <x-ui.input wire:model="form.engine_type" placeholder="e.g. 1.3L / 2NZ-FE" />
                        <x-ui.error name="form.engine_type" />
                    </x-ui.field>

                    <x-ui.field>
                        <x-ui.label>Year Range</x-ui.label>
                        <x-ui.input wire:model="form.year_range" placeholder="e.g. 2014-2018" />
                        <x-ui.error name="form.year_range" />
                    </x-ui.field>
                </div>

                <x-ui.field class="mt-5">
                    <x-ui.label>Description (Optional)</x-ui.label>
                    <x-ui.textarea wire:model="form.description" placeholder="e.g. Compatible with 1.5L engines" rows="3" />
        ...
        <div class="col-span-1 lg:col-span-3 gap-3 flex justify-end">
            <x-ui.button variant="danger" href="{{ route('inventory.motor-shop.products') }}">
                Cancel
            </x-ui.button>
