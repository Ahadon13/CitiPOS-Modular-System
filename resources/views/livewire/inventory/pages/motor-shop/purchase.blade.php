<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3 justify-end">
            ...
            <x-ui.button variant="outline" icon="inbox-arrow-down" href="{{ route('inventory.motor-shop.purchases.record') }}">
                Record Receiving
            </x-ui.button>
            <x-ui.button icon="plus" href="{{ route('inventory.motor-shop.purchases.create') }}">
                New Purchase Order
            </x-ui.button>
        </div>
    </div>
    ...
    {{-- Receive Order Modal --}}
    <livewire:inventory.pages.motor-shop.purchase.receive-purchase-modal wire:model="selected_purchase" />
    {{-- View/Print Modal --}}
    <livewire:inventory.pages.motor-shop.purchase.view-purchase-modal wire:model="view_purchase" />
