<div class="max-w-7xl mx-auto space-y-6">
    ...
    <x-ui.card hoverless size="full">
        ...
        <p class="text-sm text-neutral-500 dark:text-neutral-400 mb-5">Manage the grocery module master data used in dropdowns and tables.</p>
    ...
    <livewire:inventory.pages.grocery.common.create-customer-type-modal />
    <livewire:inventory.pages.grocery.common.create-unit-modal />
    <livewire:inventory.pages.grocery.common.create-payment-method-modal />
</div>
