...
<div class="max-w-7xl mx-auto space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">Grocery Products</h1>
            <p class="text-neutral-500 dark:text-neutral-400">Manage grocery items, packaging, pricing, and stock</p>
        </div>
        <div class="flex items-center gap-3 justify-end">
            <x-ui.button href="{{ route('inventory.grocery.products.import') }}" icon="arrow-down-tray">
                Import Products
            </x-ui.button>
            <x-ui.button href="{{ route('inventory.grocery.products.create') }}" icon="plus">
                Add Product
            </x-ui.button>
                            ...
                            <tr class="hover:bg-white/5 transition-colors group">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <x-ui.button size="xs" icon="pencil-square" variant="outline" color="blue" href="{{ route('inventory.grocery.products.edit', ['product' => $product]) }}" title="Edit Product" />
                                    ...
                                    <x-ui.empty>
                                        ...
                                        <x-ui.empty.contents>
                                            ...
                                            <div class="flex gap-2">
                                                <x-ui.button size="sm" href="{{ route('inventory.grocery.products.import') }}" icon="arrow-down-tray">
                                                    Import Products
                                                </x-ui.button>
                                                <x-ui.button size="sm" href="{{ route('inventory.grocery.products.create') }}" icon="plus">
                                                    Add Product
                                                </x-ui.button>
                                            </div>
                                        </x-ui.empty.contents>
