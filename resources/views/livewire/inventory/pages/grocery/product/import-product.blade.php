    ...
    <x-ui.card hoverless size="full">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div class="flex gap-3">
                <x-ui.button variant="outline" size="sm" icon="arrow-down-tray" href="{{ asset('storage/import/grocery_product_import_template.xlsx') }}">
                    Download Template
                </x-ui.button>
            </div>
        </div>
            ...
            <table class="min-w-full divide-y divide-neutral-200 dark:divide-white/10 text-sm text-left">
                ...
                <tbody class="divide-y divide-neutral-200 dark:divide-white/10 bg-white dark:bg-transparent text-neutral-800 dark:text-neutral-200">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3">Lucky Me Pancit Canton</td>
                        <td class="px-4 py-3">Noodles</td>
                        ...
                        <td class="px-4 py-3 text-neutral-400">Chicken flavor, 80g pack</td>
                    </tr>
                    {{-- Packaging Row --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @php
                        $required = ['product_code', 'brand_name', 'category', 'supplier', 'unit', 'conversion', 'cost_price', 'selling_price', 'quantity_on_hand', 'reorder_level', 'expiration_date'];
                        @endphp
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @php
                        $optional = ['description', 'batch_number', 'barcode'];
                        @endphp
