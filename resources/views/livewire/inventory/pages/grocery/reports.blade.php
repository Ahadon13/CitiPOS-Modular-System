<div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="space-y-4">
            ...
            <x-ui.card hoverless size="full" class="bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-900/20 dark:to-[#0a1331] border-indigo-100 dark:border-indigo-900/30">
                ...
                <div class="pt-4 border-t border-indigo-100 dark:border-indigo-900/30 text-xs text-neutral-500 leading-relaxed">
                    This represents the total capital currently tied up in physical grocery stock, based on supplier cost.
                </div>
                <div class="mt-4 pt-4 border-t border-indigo-100 dark:border-indigo-900/30">
                    <x-ui.button variant="outline" class="w-full justify-center" href="{{ route('inventory.grocery.stocks') }}">
    ...
    @include('livewire.inventory.pages.shared.stock-movements-ledger', [
        ...
        'stockMovementDescription' => 'Inventory transaction ledger for grocery stock IN and OUT within the selected report date range.',
        'stockMovementEmptyDescription' => 'No grocery inventory transactions match this report range.',
