<div class="max-w-7xl mx-auto space-y-6" x-data="{
    ...
    <x-ui.breadcrumbs>
        <x-ui.breadcrumbs.item href="{{ route('inventory.grocery.purchases') }}">Purchases</x-ui.breadcrumbs.item>
    ...
    <div class="flex items-center gap-5 justify-between">
        ...
        <x-ui.button variant="outline" icon="arrow-left" color="neutral" href="{{ route('inventory.grocery.purchases') }}">
             Back to Orders
         </x-ui.button>
    </div>
