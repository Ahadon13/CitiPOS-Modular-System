        ...
        <div class="flex-1 overflow-y-auto p-4 bg-neutral-50/50 dark:bg-[#060A23] custom-scrollbar">
            ...
            <div class="flex flex-col gap-2">
                @foreach($this->products as $product)
                    <div
                        wire:key="pos-motor-shop-product-{{ $product->id }}"
                        ...
                        <div class="flex items-center gap-3 overflow-hidden">
                            ...
                            <div class="truncate">
                                ...
                                <div class="flex flex-wrap items-center gap-2 mt-1">
                                    @foreach(['description', 'part_number', 'vehicle_model', 'engine_type', 'year_range', 'oem_number'] as $detail)
                                        @if($product->{$detail})
                                            <span class="text-xs text-neutral-500 dark:text-neutral-400">{{ $product->{$detail} }}</span>
                                        @endif
                                    @endforeach
    ...
    <x-ui.modal id="customer-form" width="lg" heading="Add New Customer">
        <form wire:submit.prevent="saveCustomer" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <x-ui.field>
                    <x-ui.label>Customer ID Number</x-ui.label>
