...
>
    ...
    <button
        ...
        {{ $attributes->class([
            'border shadow-xs bg-white truncate border-black/10 dark:bg-neutral-900 dark:border-white/15 rounded-box text-base sm:text-sm px-2 py-2 text-start focus:ring-2 focus:ring-offset-0 focus:outline-none focus:border-black/15 dark:focus:border-white/20 focus:ring-neutral-900/15 dark:focus:ring-neutral-100/15',
